...
INSERT INTO `salespeople` VALUES (1,'Daron','Burke','555-925-3685','dburke@salesperson.com'),(2,'Sherry','Trevino','555-435-1036','strevino@salesperson.com'),(3,'Irene','Boling','555-736-2301','iboling@salesperson.com'),(4,'Robert','Hamilton','555-866-6131','rhamilton@salesperson.com'),(5,'Ken','Barker','555-352-9654','kbarker@salesperson.com'),(6,'Elizabeth','Olson','555-532-3209','eolson@salesperson.com'),(7,'Samuel','Hunter','555-682-7543','shunter@salesperson.com'),(8,'Kim','Stanley','555-302-7805','kstanley@salesperson.com'),(9,'Barbara','Hinckley','555-437-1355','bhinckley@salesperson.com'),(10,'\'\'\'\'\'\'\'\'\'\'\'\'\'\'\'','<script>alert(\"XSS!\");</script>','111-111-1111','test@test.com'),(11,'\'\'\'\'aaaa','\'\'\'\'\'\'\'\'\'\'\'\'\'\'','111-111-1111','test@test.com');
...
INSERT INTO `users` VALUES (1,'Larry','Fowler','lf@example.com','lfowler99','2016-06-01 08:15:45'),(2,'aaaaa','<script>alert(\"xss!\");</script>','test@test.com','sqli\' OR (1=1 AND SLEEP(5)=0) --\'','2017-01-14 00:33:16'),(3,'test','test','test@test.com','example.php?id=%3Cscript%3Ealert%28%27XSS%21%27%29%3B%3C%2Fscript%3E','2017-01-14 01:44:34'),(4,'test','test','test@test.com','sqli\' OR (1=1 AND SLEEP(5)=0) --\'','2017-01-14 01:51:29'),(5,'aa','aa','test@test.com','sqli\' OR (1=1 AND SLEEP(5)=0) --\'','2017-01-14 01:51:57');
...
-- Dump completed on 2017-01-14  7:43:57
